...
| Java | `io.github.xsronhou:scrapio-java` | [Maven Central](https://central.sonatype.com/artifact/io.github.xsronhou/scrapio-java) |
...
```gradle
implementation 'io.github.xsronhou:scrapio-java:1.0.1'
```
...
- [TypeScript SDK changelog](https://github.com/xsronhou/scrapio/blob/main/packages/sdk-typescript/CHANGELOG.md)
- [Python SDK changelog](https://github.com/xsronhou/scrapio/blob/main/packages/sdk-python/CHANGELOG.md)
- [Go SDK changelog](https://github.com/xsronhou/scrapio/blob/main/packages/sdk-go/CHANGELOG.md)
- [Ruby SDK changelog](https://github.com/xsronhou/scrapio/blob/main/packages/sdk-ruby/CHANGELOG.md)
- [PHP SDK changelog](https://github.com/xsronhou/scrapio/blob/main/packages/sdk-php/CHANGELOG.md)
- [Java SDK changelog](https://github.com/xsronhou/scrapio/blob/main/packages/sdk-java/CHANGELOG.md)
