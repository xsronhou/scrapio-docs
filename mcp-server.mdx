...
| `amazon_search` | Search Amazon and return structured product listings |
| `amazon_search_crawl` | Queue an async, multi-page Amazon search crawl — returns a job ID |
| `walmart_search` | Search Walmart and return structured product listings. Requires a Starter plan or higher. |
| `walmart_search_crawl` | Queue an async, multi-page Walmart search crawl — returns a job ID |
...
| `booking_search` | Search Booking.com for hotels by location and stay dates. Requires the Travel add-on. |
| `booking_property` | Get structured details — amenities, room rates, review score — for a single Booking.com property |
| `booking_reviews` | Get guest reviews and the score breakdown for a Booking.com property |
| `agoda_search` | Search Agoda for hotels by location and stay dates. Requires the Travel add-on. |
| `agoda_property` | Get structured details — amenities, room rates, review score — for a single Agoda property |
| `agoda_reviews` | Get guest reviews and the score breakdown for an Agoda property |
