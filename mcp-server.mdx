...
| `amazon_product` | Get structured product data from Amazon by URL, ASIN, or search query. Requires the Commerce add-on on the account. |
| `walmart_search` | Search Walmart and return structured product listings. Requires the Commerce add-on on the account. |
