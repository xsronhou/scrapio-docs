...
<Card title="MCP Server" icon="robot" href="/mcp-server">
  One-line install for Claude Desktop, Cursor, and Windsurf. 22 tools covering fetch, search, crawl, browser automation, and dedicated Amazon/Walmart/YouTube/Booking.com/Agoda APIs.
</Card>
