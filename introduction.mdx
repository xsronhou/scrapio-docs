...
<CardGroup cols={2}>
  ...
  <Card title="Amazon" icon="bag-shopping" href="/api-reference/amazon">
    Search Amazon, fetch product details, and retrieve pricing data.
  </Card>
  <Card title="Walmart" icon="store" href="/api-reference/walmart">
    Search Walmart and retrieve structured product and catalog data.
  </Card>
