...
<CardGroup cols={2}>
  ...
  <Card title="Search (paid plan)" icon="magnifying-glass" href="/api-reference/search">
    Run a Google search and optionally fetch each result page in the same call. Requires a Starter plan or higher.
  </Card>
  ...
  <Card title="YouTube (paid plan)" icon="youtube" href="/api-reference/youtube">
  ...
  <Card title="Google (paid plan)" icon="globe" href="/api-reference/google">
    Run dedicated Google SERP requests with locale, device, and search-mode controls. Requires a Starter plan or higher.
  </Card>
  <Card title="Instagram (paid plan)" icon="instagram" href="/api-reference/instagram">
    Fetch profiles, posts, Story Highlights, search, and Reels across 19 dedicated endpoints. Requires a Starter plan or higher.
  </Card>
  <Card title="Twitter / X (paid plan)" icon="x-twitter" href="/api-reference/twitter">
    Fetch profiles, tweets, search, and Communities across 6 dedicated endpoints. Requires a Starter plan or higher.
  </Card>
  <Card title="Facebook (paid plan)" icon="facebook" href="/api-reference/facebook">
