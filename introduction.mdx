...
<CardGroup cols={2}>
  ...
  <Card title="Booking.com (add-on)" icon="hotel" href="/api-reference/booking">
    Search hotel availability, retrieve property details and room rates, and get review scores. Requires the Travel add-on.
  </Card>
