...
For pages where you don't want to define an extraction schema, top-level `mode: "content"` hashes the page's markdown output and compares the hash between runs:
