...
```
estimated_credits = max_pages × 2
```

Crawl bills a flat 2 credits per page regardless of extraction — `render_js` isn't a Crawl parameter, and adding `extract` doesn't change the per-page cost.
